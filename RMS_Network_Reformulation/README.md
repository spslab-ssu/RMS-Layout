...
핵심 baseline에서는 shared resource를 끕니다. 기존 shared-resource 제약은
`--shared-resources`로 켤 수 있지만, 논문 baseline과 확장 실험을 섞지 않도록
결과 경로와 설정을 분리하는 것을 권장합니다. Relocation은 다음 연구 단계로 남겨둡니다.
